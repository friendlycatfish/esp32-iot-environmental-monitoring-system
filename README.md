...
| :---: | :---: |
| ![PCB_Soldered](images/ten-file-anh-mach-da-han.jpg) | ![Final_Product](images/ten-file-anh-san-pham.jpg) |
| *Hình 3: Mạch PCB thực tế với các linh kiện dán (SMD) được hàn lắp thủ công[cite: 1].* | *Hình 4: Toàn bộ hệ thống được tích hợp gọn gàng trong hộp nhựa kỹ thuật[cite: 1].* |
