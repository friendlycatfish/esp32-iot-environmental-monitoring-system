...
| :---: | :---: |
| ![PCB_Soldered](images/mach-da-han.jpg) | ![Final_Product](images/san-pham-hoan-thien.jpg) |
| *Hình 3: Mạch PCB thực tế với các linh kiện dán (SMD) được hàn lắp thủ công.* | *Hình 4: Toàn bộ hệ thống được tích hợp gọn gàng trong hộp nhựa kỹ thuật.* |
